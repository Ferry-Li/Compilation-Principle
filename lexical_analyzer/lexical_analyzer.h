...
//if=1,while=10,break=13,do=11,else=4
string reserve[] = {"if","int","bool","else","float","double","char","using","for","while","do","continue","break",\
                   "return","void","namespace","cout","endl"};
char ch, prech = '$';
string name;
bool flag;
int row = 1;

const int whilestmt = 29;
const int ifstmt = 30;
